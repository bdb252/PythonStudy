...
/*
형식2: insert문 작성시 컬럼을 명시하지 않으면 전체컬에 대해
	입력값을 기술해야하므로 실행시 오류가 발생할 수 있어 권장하지 
	않는다.
*/	
INSERT INTO tb_int
...
CREATE TABLE tb_spec(
	...
	spec1 ENUM ('M','W','T'),
	spec2 SET ('A','B','C','D'),
	/* 아웃라인 방식으로 컬럼을 먼저 생성한 후 별도로 기본키를 
	지정함*/
	PRIMARY KEY(idx)
);
...
INSERT INTO tb_spec(spec1,spec2) VALUES ('X','A,B,C'); #에러발생
INSERT INTO tb_spec(spec1,spec2) VALUES ('M','X,B,C'); #에러발생
